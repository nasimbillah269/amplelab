...
<html lang="en">
    <head>
     ...
     <!-- Font Awesome-->
     <link rel="stylesheet" type="text/css" href="{{assetUrl('assets/css/vendors/fontawesome.css')}}" />
     <!-- Iconsax icon-->
     <link rel="stylesheet" type="text/css" href="{{assetUrl('assets/css/vendors/iconsax.css')}}" />
     <!-- Bootstrap css-->
     <link rel="stylesheet" type="text/css" id="rtl-link" href="{{assetUrl('assets/css/vendors/bootstrap.css')}}" />
     <link rel="stylesheet" type="text/css" href="{{assetUrl('assets/css/vendors/swiper-slider/swiper-bundle.min.css')}}" />
     <link rel="stylesheet" type="text/css" href="{{assetUrl('assets/css/vendors/toastify.css')}}" />
     <link rel="stylesheet" type="text/css" href="{{assetUrl('assets/css/style.css')}}" />
     <link rel="stylesheet" type="text/css" href="{{assetUrl('assets/css/newStyle.css')}}" />
     <link rel="stylesheet" type="text/css" href="{{assetUrl('assets/css/productsdeta.css')}}" />
     <link rel="stylesheet" type="text/css" href="{{assetUrl('assets/css/coustomeV1.css')}}" />
     <link rel="stylesheet" type="text/css" href="{{assetUrl('assets/css/respon.css')}}" />
     <link rel="stylesheet" type="text/css" href="{{assetUrl('assets/css/amplelabStyle.css')}}" />
     
       <!-- Slick Slider CSS CDN-->
        <link rel="stylesheet" type="text/css" href="{{assetUrl('assets/css/slick.css')}}" />
        <link rel="stylesheet" type="text/css" href="{{assetUrl('assets/css/slick-theme.css')}}" />
        <link rel="stylesheet" type="text/css" href="{{assetUrl('assets/css/jquery.fancybox.css')}}" />
        <link rel="stylesheet" type="text/css" href="{{assetUrl('assets/css/jquery.fancybox.min.css')}}" />
...
<!-- Bootstrap js-->
     <script src="{{assetUrl('assets/js/bootstrap/bootstrap.bundle.min.js')}}"></script>
     <!-- iconsax js -->
     <script src="{{assetUrl('assets/js/iconsax.js')}}"> </script>
     <!-- cursor js-->
     <script src="{{assetUrl('assets/js/stats.min.js')}}"> </script>
     <!--<script src="{{assetUrl('assets/js/cursor.js')}}"> </script>-->
     <script src="{{assetUrl('assets/js/swiper-slider/swiper-bundle.min.js')}}"></script>
     <script src="{{assetUrl('assets/js/swiper-slider/swiper-custom.js')}}"></script>
     <script src="{{assetUrl('assets/js/countdown.js')}}"></script>
     <script src="{{assetUrl('assets/js/newsletter.js')}}"></script>
     <script src="{{assetUrl('assets/js/skeleton-loader.js')}}"></script>
     <!-- touchspin-->
     <script src="{{assetUrl('assets/js/touchspin.js')}}"></script>
     <!-- cookie js-->
     <script src="{{assetUrl('assets/js/cookie.js')}}"></script>
     <!-- tost js -->
     <script src="{{assetUrl('assets/js/toastify.js')}}"></script>
     <script src="{{assetUrl('assets/js/theme-setting.js')}}"></script>
     <!-- Theme js-->
     <script src="{{assetUrl('assets/js/script.js')}}"></script>
        ...
        <script src="{{assetUrl('assets/js/animation.js')}}"></script>
        <script src="{{assetUrl('assets/js/slick.js')}}"></script>
        <script src="{{assetUrl('assets/js/slick.min.js')}}"></script>
        <script src="{{assetUrl('assets/js/jquery.fancybox.min.js')}}"></script>
