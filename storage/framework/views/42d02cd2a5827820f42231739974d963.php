...
<div class="topbar d-none d-md-block">
  <div class="container d-flex justify-content-between align-items-center flex-wrap">
    <div class="d-flex align-items-center flex-wrap">
      <span><i class="fa-solid fa-location-dot me-1"></i> <?php echo e(general()->address_one); ?></span>
      <span class="divider">|</span>
      <a href="tel:+8801712345678"><i class="fa-solid fa-phone me-1"></i> <?php echo e(general()->mobile); ?></a>
      <span class="divider">|</span>
      <a href="mailto:info@amplelab.com"><i class="fa-solid fa-envelope me-1"></i> <?php echo e(general()->email); ?></a>
      <span class="divider">|</span>
      <span><i class="fa-regular fa-clock me-1"></i> <?php echo e(general()->address_two); ?></span>
    </div>
    <div class="social-icons">
       <?php if(general()->facebook_link): ?><a href="<?php echo e(general()->facebook_link); ?>" target="_blank" rel="noopener"><i class="fa-brands fa-facebook-f"></i></a><?php endif; ?>
       <?php if(general()->linkedin_link): ?><a href="<?php echo e(general()->linkedin_link); ?>" target="_blank" rel="noopener"><i class="fa-brands fa-linkedin-in"></i></a><?php endif; ?>
       <?php if(general()->youtube_link): ?><a href="<?php echo e(general()->youtube_link); ?>" target="_blank" rel="noopener"><i class="fa-brands fa-youtube"></i></a><?php endif; ?>
       <?php if(general()->instagram_link): ?><a href="<?php echo e(general()->instagram_link); ?>" target="_blank" rel="noopener"><i class="fa-brands fa-instagram"></i></a><?php endif; ?>
    </div>
  </div>
</div>
...
<div class="collapse navbar-collapse" id="mainNav">
    <div class="al-nav-head">
      <img src="<?php echo e(assetUrl(general()->logo())); ?>" alt="<?php echo e(general()->title); ?>" class="al-nav-logo">
    ...
    <?php endif; ?> <a href="<?php echo e(route('pageView', 'request-quotation')); ?>" class="btn-al-primary"> Request a Quotation </a>
</div>
