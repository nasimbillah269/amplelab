    ...
    <?php $__currentLoopData = $carts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
       <li>
        <a href="<?php echo e(route('productView',$cart->product->slug?:'no-title')); ?>">
            <img src="<?php echo e(assetUrl($cart->product->image())); ?>" alt="<?php echo e($cart->product->name); ?>" />
        </a>
        <div>
           <h6 class="mb-0"><?php echo e($cart->product->name); ?></h6>
           <p><?php echo e($cart->quantity); ?> &times; <b><?php echo e(priceFullFormat($cart->itemprice())); ?></b></p>
         </div>
         <i class="fa fa-trash cartUpdate" style="cursor: pointer;" data-url="<?php echo e(route('changeToCart', [$cart->id, 'delete'])); ?>" ></i>
       </li>
...
</div><?php /**PATH D:\xampp\htdocs\amplelab\resources\views/welcome/carts/includes/headerCartBox.blade.php ENDPATH**/ ?>