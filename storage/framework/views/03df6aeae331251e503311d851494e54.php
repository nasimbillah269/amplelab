       ...
       <ul class="nav navbar-nav flex-row">
         ...
         <li class="nav-item mr-auto">
          <a class="navbar-brand" href="<?php echo e(route('index')); ?>">
             <img class="brand-logo" src="<?php echo e(assetUrl(general()->favicon())); ?>" style="max-height:30px;background: white;border-radius: 50%;" />
             <h2 class="brand-text">Ample Lab</h2>
           </a>
           </li>
         ...
         <ul class="nav navbar-nav float-right">
           ...
           <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="javascript:void(0)" data-toggle="dropdown">
               <div class="avatar avatar-online">
                <img src="<?php echo e(assetUrl(Auth::user()->image())); ?>" alt="avatar" /><i></i>
              </div>
 ...
 <!-- END: Header--><?php /**PATH D:\xampp\htdocs\amplelab\resources\views/admin/layouts/header.blade.php ENDPATH**/ ?>