        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="order_review">
                    ...
                    <div class="payment_method" style="max-width: 300px;">
                        ...
                        <div class="payment_option">
                            ...
                            <div class="custome-radio">
                                <input class="form-check-input" type="radio" name="payment_option" id="Cash" value="Cash on delivery" checked="">
                                <label class="form-check-label" for="Cash " style="cursor: pointer;">Cash on delivery </label>
                            </div>
                         <!--<div class="custome-radio">-->
                    ...
                    I accept the <a href="<?php echo e(assetUrl('/terms-and-conditions')); ?>" target="_blank">Terms And Conditions</a> outlined, including <a href="<?php echo e(assetUrl('/return-policy')); ?>" target="_blank" >Return Policy</a>,<a href="<?php echo e(assetUrl('/refund-policy')); ?>" target="_blank">Refund Policy</a>, <a href="<?php echo e(assetUrl('/privacy-policy')); ?>" target="_blank">Privacy Policy</a> . I agree to comply before placing my order.
                    </p>
    ...
    $(document).ready(function(){
        ...
        $('.selectMethod').on('change', function () {
            ...
            if (method === 'EMI Online Payment') {
                $('#paymentImage')
                    .attr('src', "<?php echo e(assetUrl('welcome/images/emi_bank.jpg')); ?>")
                    .show();
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make(welcomeTheme().'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\amplelab\resources\views/welcome/carts/checkout.blade.php ENDPATH**/ ?>