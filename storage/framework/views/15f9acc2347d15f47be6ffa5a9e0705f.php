...
<meta name="image" property="og:image" content="<?php echo e(assetUrl($product->image())); ?>" />
...
<script type="application/ld+json">
{
  ...
  "@type": "Product",
  "name": "<?php echo e($product->name); ?>",
  "image": "<?php echo e(assetUrl($product->image())); ?>",
          ...
          <div class="col-12 col-md-5 col-lg-5">
                ...
                <div class="mgmt-detail-img-wrap largeImage">
                    <div class="mgmt-detail-img-zoom-wrap">
                        <img src="<?php echo e(assetUrl($product->image())); ?>" alt="<?php echo e($product->name); ?>" class="mgmt-detail-img" id="mgmtMainImage">
                        <div class="mgmt-zoom-lens"></div>
                        <div class="mgmt-zoom-result"></div>
                    </div>

                    <div class="mgmt-thumbnails-wrap">
                        <div class="mgmt-thumbnail-item active" data-src="<?php echo e(assetUrl($product->image())); ?>">
                            <img src="<?php echo e(assetUrl($product->image())); ?>" alt="<?php echo e($product->name); ?>">
                        </div>
                        <?php if(isset($product->galleryFiles) && $product->galleryFiles->count() > 0): ?>
                            <?php $__currentLoopData = $product->galleryFiles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gallery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="mgmt-thumbnail-item" data-src="<?php echo e(assetUrl($gallery->image())); ?>">
                                    <img src="<?php echo e(assetUrl($gallery->image())); ?>" alt="Gallery Image">
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php endif; ?>
                    </div>
            ...
            <div class="detail-info-container">
             ...
             <div class="detail-header-actions position-relative">
                    ...
                    <div class="share-dropdown" id="shareMenu">
                        ...
                        <a href="https://wa.me/?text=<?php echo e(urlencode($product->name.' '.url()->current())); ?>"
                           target="_blank">
                            <i class="fa-brands fa-whatsapp"></i> WhatsApp
                        </a>
                
                        <a href="https://twitter.com/intent/tweet?text=<?php echo e(urlencode($product->name)); ?>&url=<?php echo e(urlencode(url()->current())); ?>"
                           target="_blank">
                    ...
                    <div>
                         <p class="mgmt-detail-price productPriceAppend">
                            ...
                            <?php if($product->regularPrice() > $product->offerPrice()): ?>
                                <del style="font-size: 0.6em; color: #777; margin-left: 10px;"><?php echo e(priceFullFormat($product->regularPrice())); ?>/-</del>
                            <?php endif; ?>
                        </p>
                    </div>
                    ...
                    <div class="pdinfo">
                        ...
                        <div class="pdinfoList">
                            <?php if($product->bar_code): ?>
                                <p class="mgmt-detail-meta-line"><b>Model:</b> <span><?php echo e($product->bar_code); ?></span></p>
                            <?php endif; ?>
                        </div>
                        
                           <div class="pdinfoList">
                               <?php if($product->sku_code): ?>
                                <p class="mgmt-detail-meta-line"><b>Product ID:</b> <span><?php echo e($product->sku_code); ?></span></p>
                            <?php endif; ?>
                        </div>
                    ...
                    <form class="addToCartForm" action="<?php echo e(route('addToCart',$product->id)); ?>" method="post">
                        ...
                        <div class="mgmt-detail-cart-row">
                            ...
                            <div class="mgmt-detail-qty-control quantityValue">
                                ...
                                <input type="number" name="quantity" class="mgmt-detail-qty-input productQtyValue" id="qty" value="1" min="1" data-max="<?php echo e($product->quantity); ?>" readonly>
                             ...
                             <button type="submit" name="orderNow" value="order" class="mgmt-detail-btn-buy buyNow buyNowSinBtn" data-product-id="<?php echo e($product->id); ?>">
                            Pre Order
                        </button>
                        
                        <button type="button" class="mgmt-detail-btn-cart addToCart addToSinBtn" data-product-id="<?php echo e($product->id); ?>" data-url="<?php echo e(route('addToCart',$product->id)); ?>">
                                Add to cart
                            </button>
...
<?php echo $__env->make(welcomeTheme().'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\amplelab\resources\views/welcome/products/productView.blade.php ENDPATH**/ ?>